...
Let me know if you need more options for other configuration file settings.

This script does the necessary quoting/escaping according to Meson's configuration file syntax.
...
Options:
 ...
 --no-generated-by-banner Suppresses the "generated by..." comment at the beginning.
...
process_command_line_argument ()
{
  case "$OPTION_NAME" in
    ...
    no-generated-by-banner)
        SUPPRESS_GENERATED_BY_BANNER=true
        ;;
...
USER_LONG_OPTIONS_SPEC+=( [no-generated-by-banner]=0 )
...
ENDIANNESS=""
MESON_COMPATIBILITY=""
SUPPRESS_GENERATED_BY_BANNER=false
...
if ! $SUPPRESS_GENERATED_BY_BANNER; then
  FILE_CONTENTS+="# This file has been generated by $SCRIPT_NAME version $VERSION_NUMBER"$'\n'$'\n'
fi
