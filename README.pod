...
or even to other bare-metal embedded architectures. This project already supports
building and debugging a minimal firmware running on a Qemu-emulated Stellaris board.
...
Copyright (C) R. Diez 2012-2020,  rdiezmail-arduino at yahoo.de
